...
class GameTest < MiniTest::Unit::TestCase
  ...
  def test_new_sets_game_teams
    ...
    game = Game.new('Tarantulas 3')
    assert_equal(1, game.game_teams.length)

    # test 2 teams
    game = Game.new('Tarantulas 3, Snakes 1')
    assert_equal(2, game.game_teams.length)

    # test more than 2 teams
    game = Game.new('Tarantulas 1, FC Awesome 0, Invaders 3')
  ...
  def test_scores
    ...
    game = Game.new('Aardvarks 5, Tarantulas 1, FC Awesome 0, Sammys 5')
